...
export class ListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.routerSubscription = this.router.events.subscribe(event => { if (event instanceof NavigationEnd && !event.urlAfterRedirects.startsWith('/configuracion-de-precios')) { this.searchService.changeSearch(''); } });
  ...
  loadData(): void {
    this.isLoading = true;
    this.repository.getAllData(this.module).subscribe((resp: IPricelevel[]) => {
      this.allData = resp;
      this.filterData();
