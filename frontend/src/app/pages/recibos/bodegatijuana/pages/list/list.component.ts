...
export class ListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.routerSubscription = this.router.events.subscribe(event => { if (event instanceof NavigationEnd && !event.urlAfterRedirects.startsWith('/recibos-bodega-tijuana')) { this.searchService.changeSearch(''); } });
