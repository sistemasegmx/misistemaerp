...
export class ListComponent implements OnInit, OnDestroy {
  ...
  loadLS() {
    this.searchHistory = JSON.parse(localStorage.getItem(`searchHistorycompra_${this.module}_${this.searchMode}`) || '[]');
    this.favorites = JSON.parse(localStorage.getItem(`searchFavoritescompra_${this.module}_${this.searchMode}`) || '[]');
    this.searchMode = localStorage.getItem(`searchModecompra_${this.module}`) || 'folio';
  }

  setSearchMode() {
    localStorage.setItem('searchModecompra_' + this.module, this.searchMode);
    this.loadData();
  }
  ...
  addRecentSearch(term: string): void {
    ...
    const key = `searchHistorycompra_${this.module}_${this.searchMode}`;
  ...
  updateFavorites(term: string, add: boolean): void {
    ...
    localStorage.setItem(`searchFavoritescompra_${this.module}_${this.searchMode}`, JSON.stringify(this.favorites));
    this.preventReopen = true;
  ...
  clearSearchHistory(): void {
    localStorage.removeItem(`searchHistorycompra_${this.module}_${this.searchMode}`);
    this.searchHistory = [];
    this.clearSearch();
    this.loadData();
  }
