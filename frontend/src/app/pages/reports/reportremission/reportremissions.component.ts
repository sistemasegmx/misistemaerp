...
@Component({
  selector: 'app-reportremissions',
  templateUrl: './reportremissions.component.html'
})
export class ReportremissionsComponent implements OnInit, OnDestroy, AfterViewInit {
