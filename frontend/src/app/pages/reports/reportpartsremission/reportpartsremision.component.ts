...
@Component({
  selector: 'app-reportpartsremision',
  templateUrl: './reportpartsremision.component.html'
})
export class ReportpartsremisionComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  columnsPDF = [
    ...
    { header: 'Cliente', dataKey: 'saleentename' },
