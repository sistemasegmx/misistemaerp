...
@Component({
  selector: 'app-reportpartsquoted',
  templateUrl: './reportpartsquoted.component.html'
})
export class ReportpartsquotedComponent implements OnInit, OnDestroy, AfterViewInit {
