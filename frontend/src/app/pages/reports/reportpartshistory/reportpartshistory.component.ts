...
@Component({
  selector: 'app-reportpartshistory',
  templateUrl: './reportpartshistory.component.html'
})
export class ReportpartshistoryComponent implements OnInit, OnDestroy, AfterViewInit {
