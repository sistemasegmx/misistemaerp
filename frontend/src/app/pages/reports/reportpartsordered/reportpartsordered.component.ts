...
@Component({
  selector: 'app-reportpartsordered',
  templateUrl: './reportpartsordered.component.html'
})
export class ReportpartsorderedComponent implements OnInit, OnDestroy, AfterViewInit {
